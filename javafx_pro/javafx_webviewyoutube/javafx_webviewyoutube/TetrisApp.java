...
public class TetrisApp extends Application {
   ...
   private Parent createContent() {
      ...
      Button quit = new Button("Quit and Get Curent Score");
      // Create a pane and set its properties
      
      VBox nbuttons = new VBox(5);
      nbuttons.setAlignment(Pos.TOP_LEFT);
      nbuttons.setPadding(new Insets(10, 10, 10, 10));
      nbuttons.getChildren().addAll(play_again, quit);
      
      play_again.setOnAction(
   ...
   */
      ...
      root.getChildren().addAll(canvas);//root.getChildren().addAll(canvas, nbuttons);
